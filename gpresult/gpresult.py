...
def parse_cli_arguments():
    argparser = argparse.ArgumentParser(
        description=_("Information about applied policies"),
    ...
    argparser.add_argument(
        ...
        action=CustomAction,
        help=_(
            "Output format: common output including environment information; outputs only the names of applied policies"
        ),
    )
    ...
    argparser.add_argument(
        ...
        action=CustomAction,
        help=_(
            "Output format (DEFAULT): is similar to the common output, in addition, the applied keys, policy values  and preferences are also output"
        ),
    )
    ...
    argparser.add_argument(
        ...
        action=CustomAction,
        help=_(
            "Output format: output of GPO names and their GUIDs\n"
    ...
    argparser.add_argument(
        ...
        "--width",
        help=_(
            "Set column widths for outputting internal tables (keys and values, preferences, ...)\n"
    ...
    argparser.add_argument(
        ...
        "--policy_guid",
        help=_(
            "Information about policy keys and values by guid\n"
    ...
    argparser.add_argument(
        ...
        "--policy_name",
        help=_(
            "Information about policy keys and values by name\n"
            "* Not applicable with <-l>/<--list>"
        ),
        type=str,
    )
    ...
    if args.policy_guid or args.policy_name:
        if output_format in ["raw", "common", "verbose"]:
            ...
            if args.policy_guid:
                ...
                gpos = gpr_get_policies.get_policies(
                    obj, cmd="guid", cmd_arg=args.policy_guid
                )

            elif args.policy_name:
                gpos = gpr_get_policies.get_policies(
                    obj, cmd="name", cmd_arg=args.policy_name
                )
